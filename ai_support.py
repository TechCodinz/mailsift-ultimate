    ...
    def _load_knowledge_base(self) -> Dict[str, Any]:
        ...
        return {
            "email_extraction": {
                ...
                "solutions": {
                    "website_extraction": "Use our web scraper feature
                        paste website content into the text area",
                    "file_formats": "We support TXT
                        CSV, HTML, PDF, DOCX, and Excel files",
                    "bulk_processing": "Use our bulk processing API
                        upload large files for batch processing",
                    "validation": "Our AI engine provides 99.9% accuracy
            ...
            "licensing": {
                ...
                "solutions": {
                    "license_issue": "Please verify your license key
                        ensure you're connected to the internet",
                    "purchase": "Visit our pricing page to purchase a license
                        crypto or card payments",
                    "renewal": "Licenses auto-renew. Check your account dashboa
                        rd for renewal status",
                    "transfer": "Contact support
                        both account details for license transfer"
                }
            },
            "technical": {
                "common_issues": [
                ...
                "solutions": {
                    "rate_limits": "Free tier has 100 requests/day. Upgrade
                        higher limits",
                    "errors": "Check our error codes documentation
                        contact support",
                    "performance": "Large files may take longer. Use our bulk A
                        PI for better performance",
                    "integration": "We provide SDKs for Python
...
Is there anything else I can help you with right now?
    ...
    def _generate_custom_response(self
        ...
        try:
            ...
            prompt = f"""
You are MailSift AI Support Assistant. Help users with email extraction
...
Provide a helpful
    concise response. If you can't help, direct them to support@mailsift.com.
            """

            response = openai.ChatCompletion.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are a helpful customer s
                        upport AI for MailSift email extraction service."},
    ...
    def create_support_ticket(self
        ...
        ticket.ai_response = self.generate_ai_response(message
            {"ticket_id": ticket_id})
    ...
    def _determine_priority(self, message: str, category: str) -> str:
        ...
        urgent_keywords = ['urgent'
            'critical', 'down', 'broken', 'not working', 'error']
        message_lower = message.lower()
    ...
    def get_chat_response(self
        session_id: str, user_message: str) -> ChatMessage:
        """Get chat response for a session"""
        if session_id not in self.chat_sessions:
            self.chat_sessions[session_id] = []

        # Add user message to session
        self.chat_sessions[session_id].append({"role": "user"
        ...
        self.chat_sessions[session_id].append({"role": "assistant"
            "content": ai_response})
