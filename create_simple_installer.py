...
pip install flask webview requests beautifulsoup4 lxml pandas openpyxl dnspytho
    n scikit-learn numpy >nul 2>&1
...
try {
    ...
    Write-Host "Please install Python from https://python.org" -ForegroundColor
         Yellow
...
'''
    ...
    print(f"📁 Package size: {Path(package_name).stat().st_size
        1024 / 1024:.1f} MB")
