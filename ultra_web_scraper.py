...
class UltraWebScraper:
    ...
    def _handle_cloudflare(self,
                           response: requests.Response) -> Optional[requests.Response]:
        ...
        try:
            ...
            for attempt in range(self.config.retry_attempts):
                try:
                    ...
                    # Handle Cloudflare
                    if response.status_code == 403 and 'cloudflare' in response.headers.get(
                            'server', '').lower():
                ...
                if result.success and result.metadata:
                    ...
                    if result.metadata.get('links_found', 0) > 0:
                        ...
                        try:
                            ...
                            soup = BeautifulSoup(result.emails, 'html.parser')
