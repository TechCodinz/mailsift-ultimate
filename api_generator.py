...
class APIGenerator:
    ...
    def generate_api_key(self, user_email: str, tier: str = "free") -> APIKey:
        ...
        api_key_obj = APIKey(
            ...
            expires_at=None if tier in ["pay_as_you_use", "pro", "enterprise"] else datetime.now() + timedelta(days=30),
            is_active=True,
            usage_stats={}
        )
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            ''', (
                ...
                int(api_key_obj.expires_at.timestamp()) if api_key_obj.expires_at else None,
    ...
    def record_usage(self, api_key: str, endpoint: str, credits_used: int, 
                    response_time_ms: int, status_code: int, user_ip: str = None):
        """Record API usage"""
        ...
        if key_info.tier != "free" and key_info.credits_remaining < credits_used:
            return False
    ...
    def purchase_credits(self, api_key: str, credits: int, amount_paid: float, 
                        payment_method: str, transaction_id: str = None) -> bool:
    ...
    def get_usage_stats(self, api_key: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'total_spent': key_info.total_credits_used * self.pricing[key_info.tier]['price_per_credit']
        }
    ...
    def get_pricing_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'credit_packages': {
                ...
                'enterprise': {'credits': 50000, 'price': 35.00, 'bonus': 15000}
            }
        }
